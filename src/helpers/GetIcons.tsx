...
export class BackgroundImage {
  private static images: ImageType[] = [
    ...
    { name: Colors.green, image: require("../assets/images/piles/green_1024_transparent.png") },
    { name: Colors.red, image: require("../assets/images/piles/red_1024_transparent.png") },
    { name: Colors.yellow, image: require("../assets/images/piles/yellow_1024_transparent.png") },
    { name: Colors.blue, image: require("../assets/images/piles/blue_1024_transparent.png") },
  ];
